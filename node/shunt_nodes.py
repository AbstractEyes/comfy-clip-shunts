    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "strength": ("FLOAT", {"default": 1.00, "min": -10.0, "max": 10.00, "step": 0.01}),
                "delta_mean": ("FLOAT", {"default": 1.00, "min": -50.0, "max": 50.00, "step": 0.01}),
                "delta_scale": ("FLOAT", {"default": 1.00, "min": -100.0, "max": 100.00, "step": 0.01}),
                "sigma_scale": ("FLOAT", {"default": 1.00, "min": -100.0, "max": 100.00, "step": 0.01}),
                "gate_probability": ("FLOAT", {"default": 0.579, "min": 0.000, "max": 1.000, "step": 0.001}),
                "gate_threshold": ("FLOAT", {"default": 0.100, "min": 0.000, "max": 1.000, "step": 0.001}),
                "noise_injection": ("FLOAT", {"default": 0.000, "min": 0.000, "max": 0.999, "step": 0.001}),
                "use_anchor": ("BOOLEAN", {"default": True}),
                ...
                "topk_mode": (["attention", "gate", "combined", "tau_softmax", "attention_collaborative"], {"default": "attention_collaborative"}),
                "guidance_scale": ("FLOAT", {"default": 7.5, "min": -10000.0, "max": 10000.0, "step": 0.1}),
