"""
    ComfyUI SD and VAE loading and management module.
    Author: ComfyUI Team
    Modified by: AbstractPhil

    The original code directly imported from the comfy.sd structure, meant to be utilized from here and replaced as needed.
    The original code cannot be directly modified, so this module serves as a wrapper to provide the necessary functionality.
    ...
    if len(clip_data) == 1:
        ...
        if te_model == TEModel.CLIP_G:
            if clip_type == CLIPType.STABLE_CASCADE:
                ...
                clip_target.clip = hidream_clip(clip_l=False, clip_g=True, t5=False, llama=False, dtype_t5=None, dtype_llama=None, t5xxl_scaled_fp8=None, llama_scaled_fp8=None)
                clip_target.tokenizer = HiDreamTokenizer
            else:
            ...
            if clip_type == CLIPType.SD3:
                ...
                clip_target.clip = hidream_clip(**t5xxl_detect(clip_data),
            ...
            clip_target.clip = hidream_clip(**llama_detect(clip_data),
            ...
            if clip_type == CLIPType.SD3:
                ...
                clip_target.clip = hidream_clip(clip_l=True, clip_g=False, t5=False, llama=False, dtype_t5=None, dtype_llama=None, t5xxl_scaled_fp8=None, llama_scaled_fp8=None)
                clip_target.tokenizer = HiDreamTokenizer
            else:
        ...
        if clip_type == CLIPType.SD3:
            ...
            clip_target.clip = hidream_clip(clip_l=clip_l, clip_g=clip_g, t5=t5, llama=llama, **t5_kwargs, **llama_kwargs)
            clip_target.tokenizer = HiDreamTokenizer
        else:
        ...
        clip_target.clip = hidream_clip(**t5xxl_detect(clip_data), **llama_detect(clip_data))
        clip_target.tokenizer = HiDreamTokenizer
